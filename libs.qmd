...
Assuming you've already installed the needed `r fontawesome::fa(name = "python", fill = "#077DC2", a11y = "sem")` [Python]{.py} _and_ `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r} packages, you can now load them.
