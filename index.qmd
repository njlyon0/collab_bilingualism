...
I'm not the first to have this idea so there are other useful [{{< fa brands python >}} Python]{.py} tutorials and specifically [{{< fa brands r-project >}} R]{.r}/[{{< fa brands python >}} Python]{.py} bilingualism resources. See below:
