...
In `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r}, the assignment operator is `<-`. To use it, the name of the new object-to-be is on the left of the arrow and the information to assign is on the right.
...
In `r fontawesome::fa(name = "python", fill = "#077DC2", a11y = "sem")` [Python]{.py}, the assignment operator is `=`. To use it, the name of the new object-to-be is on the left of the equal sign and the information to assign is on the right.
...
Addition, subtraction, multiplication, and division share operators across both languages (`+`, `-`, `*`, and `/` respectively). However, in `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r} exponents use `^`.
...
Addition, subtraction, multiplication, and division share operators across both languages (`+`, `-`, `*`, and `/` respectively). However, in `r fontawesome::fa(name = "python", fill = "#077DC2", a11y = "sem")` [Python]{.py} exponents use `**`
...
Some operations are only possible on some categories of information. For instance, we can only perform arithmetic on numbers. In `r fontawesome::fa(name = "python", fill = "#077DC2", a11y = "sem")` [Python]{.py} this is known as the [variable]{.py}'s [type]{.py} & while in `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r} this is the [object]{.r}'s [class]{.r}. In either case, it's important to know--and be able to check--this information about the [variables]{.py}/[objects]{.r} with which we are working.

:::panel-tabset
## `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` R

In `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r} we use the `class` function to get this information. Note that the names of `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r} classes sometimes differ from their equivalents in `r fontawesome::fa(name = "python", fill = "#077DC2", a11y = "sem")` [Python]{.py}.
...
In python, the `type` function returns the type of the data object. Note that the names of `r fontawesome::fa(name = "python", fill = "#077DC2", a11y = "sem")` [Python]{.py} types sometimes differ from their equivalents in `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r}.
...
In `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r}, one of the fundamental data structures is a "vector". Vectors are assembled with the concatenation function (`c`) where each item is separated by commas (`,`) and the set of them is wrapped in parentheses (`(...)`).
...
In `r fontawesome::fa(name = "python", fill = "#077DC2", a11y = "sem")` [Python]{.py} the fundamental data structure is a "list". Lists are assembled either by wrapping the items to include in square brackets (`[...]`) or by using the `list` function. In either case, each item is separated from the others by commas (`,`).
...
One crucial difference between `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r} and `r fontawesome::fa(name = "python", fill = "#077DC2", a11y = "sem")` [Python]{.py} is that `r fontawesome::fa(name = "python", fill = "#077DC2", a11y = "sem")` [Python]{.py} is "0-based" meaning that the first [item]{.py} is at index position `0` while in `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r} the position of the equivalent [element]{.r} is `1`.
...
In `r fontawesome::fa(name = "r-project", fill = "#FF9B00", a11y = "sem")` [R]{.r}, when we write two numbers separated by a colon (`:`), that indicates that we want those two numbers and all integers between them.
